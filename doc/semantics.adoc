...
their instances. Meta-nodes may also be macros, this is the case for
the builtin `?->` and `case` meta-nodes in the `core` module, however at
present there is no functionality for user-defined macros.
